...
var config = {
    ...
    hosts: {
        ...
        // authdomain: 'meet.{{ domain }}',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.meet.{{ domain }}',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'meet.{{ domain }}',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://meet.{{ domain }}/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://meet.{{ domain }}/' + subdir + 'xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.meet.{{ domain }}',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="meet.{{ domain }}" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://meet.{{ domain }}/static/oauth.html'
    //     redirectURI:
    //          'https://meet.{{ domain }}/subfolder/static/oauth.html',
    // },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.meet.{{ domain }}',
